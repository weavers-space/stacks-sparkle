...
if ( preg_match("/sparkle/i", $_SERVER['HTTP_USER_AGENT']) ) {
	...
	// Interate through all the possible sparkle updates. The product name will be the actual name of the app 
	// Examples: MyApp.app => MyApp, DispatchMobileMe.stack => DispatchMobileMe
	switch ($product_name) {
	    case "0.Styled-Stack":
